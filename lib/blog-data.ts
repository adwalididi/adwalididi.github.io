...
export const blogPosts: BlogPost[] = [
  {
    ...
    keywords: ["google business profile setup india", "google business profile optimisation", "GBP for local business", "google my business india 2026"],
    content: `## Why Your Google Business Profile Matters More Than Your Website
...
**WhatsApp us for a free audit of your current Google profile — we'll tell you exactly what's missing and what to fix first.**`,
  },
  {
    ...
    keywords: ["meta ads vs google ads", "facebook ads vs google ads india", "which ads for small business", "google ads or facebook ads better"],
    content: `## The Question Every Small Business Owner Asks
...
**Not sure which platform is right for your business? WhatsApp us — we'll give you a straight answer, not a sales pitch.**`,
  },
  {
    ...
    keywords: ["google ads not working", "google ads mistakes india", "why google ads no results", "google ads for small business india"],
    content: `## "I Tried Google Ads. It Didn't Work."
...
**Think your Google Ads could be performing better? WhatsApp us for a free audit — we'll tell you exactly what's wrong and how to fix it.**`,
  },
  {
    ...
    keywords: ["facebook ads cost india", "meta ads cost india 2026", "facebook advertising cost", "how much facebook ads cost"],
    content: `## Let's Talk Real Numbers
...
**Want to know what Meta Ads would cost for your specific business? WhatsApp us — we'll give you realistic numbers based on your industry and location, not generic estimates.**`,
  },
  {
    ...
    keywords: ["digital marketing agency for small business india", "when to hire digital marketing agency", "local business marketing india", "small business digital marketing"],
    content: `## Not Every Business Needs an Agency
