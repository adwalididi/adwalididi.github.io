...
If your current marketing isn't bringing in the enquiries you need, let's have a straightforward WhatsApp chat about what we can do.`}];var i=e.i(72520),r=e.i(87316),l=e.i(3116),d=e.i(24511),u=e.i(78397);e.s(["BlogContent",0,function(){let[e,h]=(0,t.useState)(!1);return(0,t.useEffect)(()=>{h(!0)},[]),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("section",{className:"pt-32 pb-8 sm:pt-40 sm:pb-12 bg-teal-tint",children:(0,o.jsxs)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center",children:[(0,o.jsx)(d.m.div,{initial:{opacity:0,y:20},animate:{opacity:+!!e,y:20*!e},transition:{duration:.8},children:(0,o.jsx)("h1",{className:"font-[var(--font-syne)] text-4xl sm:text-5xl lg:text-6xl font-bold text-near-black leading-tight",children:"Blog"})}),(0,o.jsx)(d.m.p,{className:"mt-6 text-lg sm:text-xl text-muted-text max-w-2xl mx-auto leading-relaxed",initial:{opacity:0,y:20},animate:{opacity:+!!e,y:20*!e},transition:{duration:.8,delay:.2},children:"Real marketing advice for Indian businesses. No jargon, no fluff — just things that actually work."})]})}),(0,o.jsx)("section",{className:"py-16 sm:py-20 bg-white",children:(0,o.jsx)("div",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,o.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8",children:n.map((t,n)=>(0,o.jsx)(d.m.div,{initial:{opacity:0,y:20},whileInView:{opacity:+!!e,y:20*!e},viewport:{once:!0,margin:"-50px"},transition:{duration:.6,delay:n%3*.1},children:(0,o.jsxs)(s.default,{href:`/blog/${t.slug}`,className:"group bg-white rounded-2xl overflow-hidden shadow-sm border border-teal-border hover:shadow-lg transition-all duration-300 flex flex-col h-full",children:[(0,o.jsxs)("div",{className:"relative aspect-[16/9] overflow-hidden",children:[(0,o.jsx)(a.default,{src:t.coverImage,alt:t.title,fill:!0,className:"object-cover transition-transform duration-500 group-hover:scale-105"}),(0,o.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-near-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"})]}),(0,o.jsxs)("div",{className:"p-6 sm:p-8 flex-1 flex flex-col",children:[(0,o.jsx)("div",{className:"flex items-center gap-3 mb-4",children:(0,o.jsx)("span",{className:"px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider bg-teal-tint text-teal",children:t.category})}),(0,o.jsx)("h2",{className:"font-[var(--font-syne)] text-lg sm:text-xl font-bold text-near-black leading-snug group-hover:text-teal transition-colors",children:t.title}),(0,o.jsx)("p",{className:"mt-3 text-muted-text text-sm leading-relaxed line-clamp-3",children:t.excerpt}),(0,o.jsxs)("div",{className:"mt-6 flex items-center justify-between",children:[(0,o.jsxs)("div",{className:"flex items-center gap-4 text-xs text-muted-text",children:[(0,o.jsxs)("span",{className:"flex items-center gap-1",children:[(0,o.jsx)(r.Calendar,{size:12}),new Date(t.date).toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"})]}),(0,o.jsxs)("span",{className:"flex items-center gap-1",children:[(0,o.jsx)(l.Clock,{size:12}),t.readingTime]})]}),(0,o.jsx)(i.ArrowRight,{size:16,className:"text-teal opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all"})]})]})]})},t.slug))})})}),(0,o.jsx)("section",{className:"py-16 sm:py-20 bg-teal-tint",children:(0,o.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center",children:(0,o.jsxs)(d.m.div,{initial:{opacity:0,y:20},whileInView:{opacity:+!!e,y:20*!e},viewport:{once:!0,margin:"-100px"},transition:{duration:.8},children:[(0,o.jsx)("h2",{className:"font-[var(--font-syne)] text-2xl sm:text-3xl lg:text-4xl font-bold text-near-black",children:"Want these strategies applied to your business?"}),(0,o.jsx)("p",{className:"mt-4 text-muted-text text-lg max-w-2xl mx-auto",children:"Reading about it is one thing. Having someone do it for you is another."}),(0,o.jsxs)(d.m.a,{href:"https://wa.me/916261643774?text=Hi!%20I%20read%20your%20blog%20and%20I'd%20like%20to%20discuss%20marketing%20for%20my%20business.",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-teal text-white px-8 py-4 rounded-xl font-medium text-lg hover:bg-deep-teal transition-all hover:scale-105 shadow-lg mt-8 group",initial:{opacity:0,y:20},whileInView:{opacity:+!!e,y:20*!e},viewport:{once:!0},transition:{duration:.8,delay:.2},children:[(0,o.jsx)("div",{className:"group-hover:animate-ring-subtle",children:(0,o.jsx)(u.WhatsAppIcon,{className:"w-6 h-6 sm:w-5 sm:h-5 shrink-0"})}),(0,o.jsx)("span",{children:"WhatsApp Us — Let's Talk"})]})]})})})]})}],60380)}]);