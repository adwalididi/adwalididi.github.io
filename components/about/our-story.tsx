  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-20 bg-cream">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div 
          className={`space-y-6 text-lg text-charcoal/80 leading-relaxed transition-all duration-700 ${
        ...
        >
          ...
          <div className="bg-saffron/10 rounded-2xl p-6 sm:p-8 my-8">
            <p className="text-charcoal">
              Our first proper project was a <span className="font-semibold">travel startup with zero online presence</span>. No Google profile. No ads. No creatives. Nothing. We built everything from scratch, and within the first month they had <span className="font-semibold text-saffron">over 150 enquiries</span> coming in.
            </p>
          </div>
          ...
          <p className="font-[var(--font-syne)] text-2xl text-charcoal font-bold">
            So here we are.
          </p>
        </div>
      </div>
