  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-20 lg:py-28 bg-muted">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-saffron/10 rounded-full mb-8">
            <Quote className="w-8 h-8 text-saffron" />
          </div>
          
          <blockquote className="font-[var(--font-syne)] text-xl sm:text-2xl lg:text-3xl text-charcoal leading-relaxed">
          ...
          <div className="mt-8">
            <p className="font-semibold text-charcoal">Travel Agency Client</p>
            <p className="text-charcoal/60">India</p>
          </div>
        </div>
      </div>
    </section>
